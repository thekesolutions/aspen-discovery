...
CREATE TABLE `aci_speedpay_settings` (
  ...
  `forceDebugLog` tinyint(1) DEFAULT 0,
  PRIMARY KEY (`id`),
  UNIQUE KEY `name` (`name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
DROP TABLE IF EXISTS admin_sticky_filters;
CREATE TABLE `admin_sticky_filters` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `userId` int(11) DEFAULT NULL,
  `filterFor` varchar(100) DEFAULT NULL,
...
CREATE TABLE `aspen_lida_branded_settings` (
  ...
  `loadingMessageType` tinyint(4) DEFAULT 0,
...
CREATE TABLE `aspen_lida_self_check_settings` (
  ...
  `barcodeEntryKeyboardType` tinyint(1) NOT NULL DEFAULT 1,
  PRIMARY KEY (`id`),
  UNIQUE KEY `name` (`name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_ci;
...
CREATE TABLE `bookcover_info` (
  ...
  `last_url_validation` int(11) DEFAULT NULL,
...
CREATE TABLE `browse_category` (
  ...
  `defaultSort` enum('relevance','popularity','newest_to_oldest','author','title','user_rating','holds','publication_year_desc','publication_year_asc','event_date','oldest_to_newest','newest_updated_to_oldest','oldest_updated_to_newest') DEFAULT 'relevance',
...
CREATE TABLE `ce_campaign` (
  ...
  `addExtraCreditActivities` tinyint(4) DEFAULT 0,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
DROP TABLE IF EXISTS ce_campaign_extra_credit;
CREATE TABLE `ce_campaign_extra_credit` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `weight` int(11) NOT NULL DEFAULT 0,
  `campaignId` int(11) NOT NULL,
  `extraCreditId` int(11) NOT NULL,
  `goal` int(11) DEFAULT 0,
  `reward` int(11) DEFAULT -1,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
DROP TABLE IF EXISTS ce_campaign_extra_credit_activity_users_progress;
...
DROP TABLE IF EXISTS ce_campaign_location_access;
...
DROP TABLE IF EXISTS ce_extra_credit;
...
CREATE TABLE `ce_reward` (
  ...
  `awardAutomatically` tinyint(1) DEFAULT 0,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `ce_user_campaign` (
  ...
  `rewardGiven` tinyint(4) DEFAULT 0,
  `optInToCampaignLeaderboard` tinyint(4) DEFAULT NULL,
  `optInToCampaignEmailNotifications` tinyint(4) DEFAULT NULL,
  `campaignCompleteEmailSent` tinyint(1) DEFAULT 0,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `comprise_settings` (
  ...
  `customerNameForDonation` varchar(50) DEFAULT NULL,
  `customerIdForDonation` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `cron_log` (
  ...
  `name` varchar(255) DEFAULT 'Primary Cron',
  PRIMARY KEY (`id`),
  KEY `startTime` (`startTime`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `curbside_pickup_settings` (
  ...
  `timeAllowedBeforeCheckIn` int(11) DEFAULT -1,
...
CREATE TABLE `event` (
  ...
  `weekNumber` tinyint(4) DEFAULT 1,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `file_uploads` (
  ...
  `owningLibrary` int(11) NOT NULL DEFAULT -1,
  `sharing` int(11) NOT NULL DEFAULT 2,
  `sharedWithLibrary` int(11) NOT NULL DEFAULT -1,
  `deleted` tinyint(1) DEFAULT 0,
  `dateDeleted` int(11) DEFAULT 0,
...
CREATE TABLE `grouped_work_display_settings` (
  ...
  `formatDisplayStyle` int(11) DEFAULT 1,
  PRIMARY KEY (`id`),
  UNIQUE KEY `name` (`name`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
DROP TABLE IF EXISTS heycentric_setting;
...
DROP TABLE IF EXISTS heycentric_url_parameter;
...
DROP TABLE IF EXISTS heycentric_url_parameter_setting;
...
DROP TABLE IF EXISTS hoopla_flex_availability;
CREATE TABLE `hoopla_flex_availability` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `hooplaId` bigint(20) NOT NULL,
  `holdsQueueSize` int(11) NOT NULL,
...
CREATE TABLE `hoopla_scopes` (
  ...
  `includeTeen` tinyint(4) DEFAULT 1,
  `includeKids` tinyint(4) DEFAULT 1,
  `includeInstant` tinyint(1) DEFAULT 1,
  `includeFlex` tinyint(1) DEFAULT 0,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
DROP TABLE IF EXISTS indexed_audience;
...
CREATE TABLE `indexing_profiles` (
  ...
  `statusAlt` char(1) DEFAULT '',
  `prioritizeAvailableRecordsForTitleSelection` tinyint(1) DEFAULT 0,
  PRIMARY KEY (`id`),
  UNIQUE KEY `name` (`name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `ip_lookup` (
  ...
  `startIpVal` varchar(255) DEFAULT NULL COMMENT 'Numeric value for IPv4 or encoded string for IPv6',
  `endIpVal` varchar(255) DEFAULT NULL COMMENT 'Numeric value for IPv4 or encoded string for IPv6',
...
CREATE TABLE `languages` (
  ...
  KEY `languageLookup` (`weight`,`displayName`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `library` (
  ...
  `maxHoldCancellationDate` int(11) DEFAULT -1,
  ...
  `patronNameDisplayStyle` enum('firstinitial_lastname','lastinitial_firstname','firstinitial_middleinitial_lastname','firstname_middleinitial_lastinitial','preferredname_lastinitial') DEFAULT 'firstinitial_lastname',
  ...
  `enableTalpaSearch` tinyint(1) DEFAULT 0,
  `campaignLeaderboardDisplay` varchar(20) DEFAULT 'displayBranch',
  `campaignCompletionNewEmail` varchar(125) DEFAULT NULL,
  `sendStaffEmailOnCampaignCompletion` tinyint(1) DEFAULT 0,
  `talpaSettingsId` int(11) DEFAULT -1,
  `heyCentricSettingId` int(11) NOT NULL DEFAULT -1,
  `palaceProjectLibraryId` varchar(50) DEFAULT NULL,
  `showPatronTypeOnCard` tinyint(1) DEFAULT 0,
  `blueskyLink` varchar(255) DEFAULT NULL,
  `threadsLink` varchar(255) DEFAULT NULL,
  `allowFilteringOfLinkedAccountsInCheckouts` tinyint(1) DEFAULT 0,
  `allowSelectingCheckoutsToExport` tinyint(1) DEFAULT 0,
  `highlightCommunityEngagement` tinyint(1) DEFAULT 0,
  `replaceAllFirstNameWithPreferredName` tinyint(1) DEFAULT 0,
  `displayCampaignLeaderboard` tinyint(1) DEFAULT 0,
  `localIllEmail` varchar(255) DEFAULT '',
  ...
  KEY `subdomainUrl` (`subdomain`,`baseUrl`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
DROP TABLE IF EXISTS library_events_facet_setting;
CREATE TABLE `library_events_facet_setting` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `libraryId` int(11) NOT NULL,
  `eventsFacetGroupId` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `library_records_to_include` (
  ...
  `subLocation` varchar(250) NOT NULL DEFAULT '',
  `includeHoldableOnly` tinyint(1) NOT NULL DEFAULT 0,
  `includeItemsOnOrder` tinyint(1) NOT NULL DEFAULT 1,
  `includeEContent` tinyint(1) NOT NULL DEFAULT 1,
  `weight` int(11) NOT NULL DEFAULT 0,
  `iType` varchar(250) DEFAULT NULL,
  ...
  `iTypesToExclude` varchar(250) DEFAULT NULL,
  `audiencesToExclude` varchar(250) DEFAULT NULL,
  `formatsToExclude` varchar(250) DEFAULT NULL,
  `shelfLocation` varchar(250) DEFAULT NULL,
  `shelfLocationsToExclude` varchar(250) DEFAULT NULL,
  `collectionCode` varchar(250) DEFAULT NULL,
  `collectionCodesToExclude` varchar(500) NOT NULL DEFAULT '',
  PRIMARY KEY (`id`),
...
CREATE TABLE `library_web_builder_custom_form` (
  ...
  `emailResultsTo` varchar(100) DEFAULT '',
  PRIMARY KEY (`id`),
  KEY `libraryId` (`libraryId`),
  KEY `formId` (`formId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
DROP TABLE IF EXISTS lida_loading_messages;
...
CREATE TABLE `location` (
  ...
  `heyCentricSettingId` int(11) NOT NULL DEFAULT -1,
  `allowUpdatingContactInfoFromILS` tinyint(1) DEFAULT 0,
  ...
  KEY `displayNameLookup` (`displayName`,`isMainBranch`,`libraryId`,`locationId`),
  KEY `libraryMainBranch` (`libraryId`,`isMainBranch`)
...
DROP TABLE IF EXISTS location_events_setting;
...
CREATE TABLE `open_archives_record` (
  ...
  `permanentUrl` varchar(2048) NOT NULL,
  `lastSeen` int(11) DEFAULT 0,
  PRIMARY KEY (`id`),
  UNIQUE KEY `sourceCollection` (`sourceCollection`,`permanentUrl`) USING HASH
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `ptype` (
  ...
  `allowLocalIll` tinyint(4) DEFAULT 1,
  PRIMARY KEY (`id`),
...
CREATE TABLE `search` (
  ...
  KEY `searchLookup` (`searchUrl`(500),`session_id`,`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
DROP TABLE IF EXISTS self_check_completion_message;
CREATE TABLE `self_check_completion_message` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `formats` varchar(500) DEFAULT NULL,
  `owningLocations` varchar(500) DEFAULT NULL,
  `checkoutLocations` varchar(500) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
DROP TABLE IF EXISTS self_reg_municipality_values_sierra;
CREATE TABLE `self_reg_municipality_values_sierra` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `selfRegistrationFormId` int(11) NOT NULL,
  `municipality` varchar(255) NOT NULL DEFAULT '',
  `municipalityType` varchar(10) DEFAULT NULL,
  ...
  `sierraPCode3` int(11) DEFAULT NULL,
  `sierraPCode4` int(11) DEFAULT NULL,
  `expirationLength` tinyint(4) DEFAULT NULL,
  `expirationPeriod` char(1) DEFAULT 'd',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `self_registration_form_sierra` (
  ...
  `selfRegNoDuplicateCheck` tinyint(1) DEFAULT 0,
  `selfRegUseAgency` tinyint(1) DEFAULT 0,
  `selfRegUsePatronIdBarcode` tinyint(1) DEFAULT 0,
  `selfRegNoticePrefOptions` varchar(255) DEFAULT '',
  `addSelfRegNote` tinyint(4) DEFAULT 1,
  PRIMARY KEY (`id`),
  UNIQUE KEY `name` (`name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
DROP TABLE IF EXISTS self_registration_sierra;
CREATE TABLE `self_registration_sierra` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `self_registration_tos` (
  ...
  `showTOSFirst` tinyint(1) DEFAULT 0,
  PRIMARY KEY (`id`),
  UNIQUE KEY `name` (`name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `series` (
  ...
  `created` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `groupedWorkSeriesTitle` (`groupedWorkSeriesTitle`),
...
CREATE TABLE `series_member` (
  ...
  `displayName` varchar(750) DEFAULT NULL,
  ...
  `deleted` tinyint(1) DEFAULT 0,
  `priorityScore` tinyint(4) NOT NULL DEFAULT 1,
  PRIMARY KEY (`id`),
  ...
  KEY `displayName` (`displayName`),
  KEY `author` (`author`),
  KEY `seriesWorkId` (`seriesId`,`groupedWorkPermanentId`,`userAdded`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `sideloads` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(50) NOT NULL,
  `marcPath` varchar(200) NOT NULL,
  `filenamesToInclude` varchar(250) DEFAULT '.*\\.ma?rc',
  `marcEncoding` enum('MARC8','UTF8','UNIMARC','ISO8859_1','BESTGUESS') NOT NULL DEFAULT 'MARC8',
  `indexingClass` varchar(50) NOT NULL DEFAULT 'SideLoadedEContentProcessor',
  `recordUrlComponent` varchar(76) NOT NULL DEFAULT 'DefineThis',
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `name` (`name`,`owningLibrary`),
  UNIQUE KEY `marcPath` (`marcPath`),
  UNIQUE KEY `recordUrlComponent` (`recordUrlComponent`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `sso_setting` (
  ...
  `createUserInIls` int(11) DEFAULT 1,
  PRIMARY KEY (`id`),
  UNIQUE KEY `name` (`name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `status_map_values` (
  ...
  `suppress` tinyint(1) DEFAULT 0,
  `inLibraryUseOnly` tinyint(1) DEFAULT 0,
  `appliesToStatusSubfield` tinyint(1) DEFAULT 1,
  `appliesToStatusAltSubfield` tinyint(1) DEFAULT 0,
  PRIMARY KEY (`id`),
  UNIQUE KEY `indexingProfileId` (`indexingProfileId`,`value`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `system_variables` (
  ...
  `supportingCompany` varchar(72) DEFAULT '',
  ...
  `lidaGitHubRepository` varchar(255) DEFAULT 'https://github.com/Aspen-Discovery/aspen-lida',
  `numBoundlessSettingsToProcessInParallel` int(11) DEFAULT 1,
  `disable_user_agent_logging` tinyint(1) DEFAULT 0,
  `logFrequentCrons` tinyint(1) DEFAULT 0,
  `removeTheWordSeriesFromEndOfSeries` tinyint(4) DEFAULT 1,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
DROP TABLE IF EXISTS talpa_ltwork_to_groupedwork;
CREATE TABLE `talpa_ltwork_to_groupedwork` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `groupedRecordPermanentId` char(40) DEFAULT NULL,
  `lt_workcode` int(11) unsigned DEFAULT NULL,
  `checked` tinyint(1) DEFAULT 0,
  PRIMARY KEY (`id`),
  KEY `groupedRecordPermanentId` (`groupedRecordPermanentId`),
  KEY `lt_workcode` (`lt_workcode`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
DROP TABLE IF EXISTS talpa_settings;
...
CREATE TABLE `themes` (
  ...
  `headerLogoAlignmentApp` tinyint(1) DEFAULT 2,
  `headerLogoBackgroundColorApp` char(7) DEFAULT '#ffffff',
  `headerLogoBackgroundColorAppDefault` tinyint(1) DEFAULT 1,
  `placardImageMaxHeight` int(11) DEFAULT 0,
  `seriesImage` varchar(100) DEFAULT '',
  PRIMARY KEY (`id`),
  KEY `themeName` (`themeName`),
  KEY `nameById` (`id`,`displayName`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `user` (
  ...
  `optInToAllCampaignLeaderboards` tinyint(4) DEFAULT 0,
  `campaignNotificationsByEmail` tinyint(4) DEFAULT 0,
  `hooplaHoldQueueSizeConfirmation` tinyint(3) DEFAULT 1,
  `holdSortAvailable` varchar(75) DEFAULT 'expire',
  `holdSortUnavailable` varchar(75) DEFAULT 'title',
  `checkoutSort` varchar(75) DEFAULT 'dueDate',
  ...
  KEY `idx_reading_history_import_status` (`initialReadingHistoryLoaded`,`forceReadingHistoryLoad`,`readingHistoryImportStartedAt`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `user_list` (
  ...
  `dateDeleted` int(11) DEFAULT 0,
  `deletedBy` int(11) DEFAULT NULL,
  `deleteFromIndex` tinyint(1) DEFAULT 0,
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`),
  KEY `dateUpdated` (`dateUpdated`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
DROP TABLE IF EXISTS user_page_defaults;
CREATE TABLE `user_page_defaults` (
  ...
  `pageSort` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `userId` (`userId`,`module`,`action`,`objectId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `user_payments` (
  ...
  `heyCentricPaymentReferenceNumber` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `web_builder_portal_cell` (
  ...
  `staticLocationId` int(11) NOT NULL DEFAULT -1,
  PRIMARY KEY (`id`),
...
INSERT INTO themes 
  ...
  1,'default','aspen-logo.png','#f1f1f1',1,'#303030',1,
...
INSERT INTO variables VALUES (1,'lastHooplaExport','false'),(2,'validateChecksumsFromDisk','false'),(3,'offline_mode_when_offline_login_allowed','false'),(4,'fullReindexIntervalWarning','86400'),(5,'fullReindexIntervalCritical','129600'),(6,'bypass_export_validation','0'),(7,'last_validatemarcexport_time',NULL),(8,'last_export_valid','1'),(9,'record_grouping_running','false'),(10,'last_grouping_time',NULL),(25,'partial_reindex_running','true'),(26,'last_reindex_time',NULL),(27,'lastPartialReindexFinish',NULL),(29,'full_reindex_running','false'),(37,'lastFullReindexFinish',NULL),(44,'num_title_in_unique_sitemap','20000'),(45,'num_titles_in_most_popular_sitemap','20000');
