...
class ImageUpload extends DataObject {
	...
	static function getObjectStructure($context = ''): array {
		...
		return [
			...
			'fullSizePath' => [
				...
				'maxWidth' => 1068,
				'maxHeight' => 1068,
				'path' => $storageManager->getUserDataPath(StorageManager::CATEGORY_IMAGES, StorageManager::CATEGORY_WEB_BUILDER, 'full'),
			...
			'xLargeSizePath' => [
				...
				'path' => $storageManager->getUserDataPath(StorageManager::CATEGORY_IMAGES, StorageManager::CATEGORY_WEB_BUILDER, 'x-large'),
			...
			'largeSizePath' => [
				...
				'path' => $storageManager->getUserDataPath(StorageManager::CATEGORY_IMAGES, StorageManager::CATEGORY_WEB_BUILDER, 'large'),
			...
			'mediumSizePath' => [
				...
				'path' => $storageManager->getUserDataPath(StorageManager::CATEGORY_IMAGES, StorageManager::CATEGORY_WEB_BUILDER, 'medium'),
			...
			'smallSizePath' => [
				...
				'path' => $storageManager->getUserDataPath(StorageManager::CATEGORY_IMAGES, StorageManager::CATEGORY_WEB_BUILDER, 'small'),
	...
	private function generateDerivatives() {
		if (!empty($this->fullSizePath) && !empty($this->id)) {
			...
			$storageManager = StorageManager::getInstance();
			$fullSizeFile = $storageManager->getUserDataPath(StorageManager::CATEGORY_IMAGES, StorageManager::CATEGORY_WEB_BUILDER, 'full') . '/' . $this->fullSizePath;
			
			if ($this->generateXLargeSize) {
				$xLargeFilePath = $storageManager->getUserDataPath(StorageManager::CATEGORY_IMAGES, StorageManager::CATEGORY_WEB_BUILDER, 'x-large');
				$storageManager->ensureDirectoryExists($xLargeFilePath);
			...
			if ($this->generateLargeSize) {
				$largeFilePath = $storageManager->getUserDataPath(StorageManager::CATEGORY_IMAGES, StorageManager::CATEGORY_WEB_BUILDER, 'large');
				$storageManager->ensureDirectoryExists($largeFilePath);
			...
			if ($this->generateMediumSize) {
				$mediumFilePath = $storageManager->getUserDataPath(StorageManager::CATEGORY_IMAGES, StorageManager::CATEGORY_WEB_BUILDER, 'medium');
				$storageManager->ensureDirectoryExists($mediumFilePath);
			...
			if ($this->generateSmallSize) {
				$smallFilePath = $storageManager->getUserDataPath(StorageManager::CATEGORY_IMAGES, StorageManager::CATEGORY_WEB_BUILDER, 'small');
				$storageManager->ensureDirectoryExists($smallFilePath);
