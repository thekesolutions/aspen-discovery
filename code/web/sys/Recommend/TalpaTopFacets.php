...
class TalpaTopFacets implements RecommendationInterface {
...
//				}
				$numButtons = 2;
				foreach ($facetSet['list'] as $facetKey => $facet) {
					if ($facetKey == 'global' || $facetKey == '') {
						$facet['display'] = 'Library Results';
						$sortedFacetList[0] = $facet;
					} elseif ($facetKey == 'talpa_result') {
						$facet['display'] = 'Other Results';
						$sortedFacetList[1] = $facet;
					}
				}
