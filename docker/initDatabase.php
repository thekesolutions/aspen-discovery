...
exec("$mysqlConnectionCommand -e\"CREATE DATABASE {$databaseName} DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci\"");
echo "Database '{$databaseName}' created successfully.\n";

//Load default database
$aspenDir = '/usr/local/aspen-discovery/';
echo "Loading default database.\n";
exec("$mysqlConnectionCommand {$databaseName} < $aspenDir/install/aspen.sql");
