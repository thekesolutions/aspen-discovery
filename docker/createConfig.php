...
$mandatory = ['sitename','servername', 'solrHost', 'solrPort', 'timezone', 'aspenAdminPassword', 'databaseHost', 'databasePort', 'databaseName', 'databaseUser', 'databasePassword', 'databaseRootUser', 'databaseRootPassword'];
$emptyVariables = 0;
